exports.up = pgm => {
    ...
    pgm.alterColumn('appeal_abandoned_jobs', 'appealed_on', {
        type: 'timestamp with time zone'
    }),
    ...
    pgm.alterColumn('milestone_conditions', 'condition_completed_date', {
        type: 'timestamp with time zone'
    }),
    ...
    pgm.alterColumn('saved_job_posts', 'saved_date', {
        type: 'timestamp with time zone'
    }),
