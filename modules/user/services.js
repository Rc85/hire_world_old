...
app.post('/api/user/services/edit', async(req, resp) => {
    if (req.session.user) {
        /* db.connect(async(err, client, done) => {
            ...
            await db.query(`UPDATE user_services SET service_name = $1, service_detail = $2, service_listed_under = $3, service_worldwide = $4, service_country = $5, service_region = $6, service_city = $7 WHERE service_id = $8 RETURNING *`, [req.body.name, req.body.detail, req.body.listUnder, req.body.worldwide, req.body.country, req.body.region, req.body.city, req.body.id])
            .then(result => {
