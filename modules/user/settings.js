                ...
                (async() => {
                    try {
                        ...
                        .then(async() => {
                            ...
                            resp.send({status: 'success', statusMessage: 'Profile saved', user: user.rows[0]});
                        });
                    } catch (e) {
                ...
                (async() => {
                    try {
                        ...
                        .then(async() => {
                            ...
                            resp.send({status: 'success', statusMessage: 'Email saved', user: user.rows[0]});
                        });
                    } catch (e) {
                        await client.query('ROLLBACK');
                        throw e;
            ...
            if (valueCheck.test(req.body.value)) {
                (async() => {
                    try {
                        ...
                        await client.query('COMMIT')
                        .then(() => resp.send({status: 'success', statusMessage: 'Saved', user: user.rows[0]}));
                    } catch (e) {
                        await client.query('ROLLBACK');
                        throw e;
                    } finally {
