...
import ViewUserBusinessHours from '../components/ViewUserBusinessHours';
...
import ViewUserWorkHistory from '../components/ViewUserWorkHistory';
                        ...
                        {<TitledContainer title={this.state.user ? this.state.user.username : ''} bgColor='yellow' icon={<FontAwesomeIcon icon={faUserCircle} />} shadow>
                            ...
                            {this.props.user.user && this.state.user && this.props.user.user.username !== this.state.user.username ?
                                <div className='text-right'>
                                    ...
                                    {this.state.message != 'propose a job' && this.state.user && this.state.user.link_work_acct_status === 'Approved' && this.props.user.user ? <button className='btn btn-success' onClick={() => this.setState({message: 'propose a job'})}>Start A Job</button> : ''}
                                </div>
                            : ''}
