        ...
        if (this.props.type === 'profiles') {
            filters = <React.Fragment>
                ...
                <div className='setting-field-container d-flex-between-center mb-3'>
                    ...
                    <div className='setting-child quarter text-center'><label htmlFor='is-linked'><input type='checkbox' id='is-linked' onClick={() => this.setState({isLinked: !this.state.isLinked})} value={this.state.isLinked} /> Linked Only</label></div>
