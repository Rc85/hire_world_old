...
const ListingRow = props => {
    ...
    return(
        <div className='listing-row mb-2'>
            ...
            <div className='w-40 text-truncate'><NavLink to={`/user/${props.listing.listing_user}`}>{props.listing.listing_title}</NavLink></div>
            ...
            <div className='w-15'>{props.editable ? '' : props.listing.job_completed}</div>
            <div className='w-15'>{props.editable ? '' : moment(props.listing.listing_created_date).format('MMM DD YYYY')}</div>
