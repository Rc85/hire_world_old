...
const ListingRow = props => {
    ...
    return(
        <div className='listing-row mb-2'>
            ...
            <div className='w-40 text-truncate'><NavLink to={`/user/${props.listing.listing_user}`}>{props.listing.listing_user}</NavLink></div>
            ...
            <div className='w-15'>{props.editable ? '' : props.listing.job_complete}</div>
