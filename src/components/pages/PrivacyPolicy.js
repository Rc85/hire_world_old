        ...
        <div>
            <section id='privacy' className='main-panel'>
                <TitledContainer title='Privacy Policy' icon={<FontAwesomeIcon icon={faFileAlt} />} shadow bgColor='primary'>
                    ...
                    <ul>
                        <li>All the fields when registering an account with HireWorld.</li>
                        ...
                        <li>Any content submitted to HireWorld by its users such as and not limited to, reviews and messages.</li>
                    ...
                    <p>HireWorld may change or modify your data if we feel the data you submit is inappropriate and/or inaccurate in any way.</p>

                    <p>HireWorld may delete your user account entirely for whatever reason we feel is justifiable by us, with or without notice to you.</p>

                    <p>HireWorld may transfer your data to another server for reasons such as and not limited to, data back-up and server migration, with or without notice to you.</p>

                    <p>HireWorld may disclose your data to public authorities to the extent demanded by law.</p>

                    <div className='text-right'><a href='#top'>Top</a></div>

                    <hr/>

                    <h2 id='deleting'>Deleting your account from HireWorld</h2>

                    <p>At HireWorld, we do not delete accounts mainly because deleting the account can affect a user's reputation, wether positively or negatively. You give you the control to delete the data related to your account such as your email and address. However, your username, first name, last name, country and region remains on the account. You may request to change the first name and last name of the account any time by contacting our support and upon providing information which verifies that you are the owner of the account, we will change it per your request.</p>
