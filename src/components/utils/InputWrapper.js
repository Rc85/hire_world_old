...
class InputWrapper extends Component {
    ...
    render() {
        return(
            <div onFocus={this.handleParentFocus.bind(this)} onBlur={this.handleParentBlur.bind(this)} onMouseDown={this.handleParentClick.bind(this)} id={this.props.id} className={`input-container ${this.props.className ? this.props.className : ''} ${this.props.disabled ? 'disabled' : ''}`}>
