...
export const Login = (state = loginInitialState, action) => {
    switch(action.type) {
        ...
        case 'UPDATE_NOTIFICATION_AND_MESSAGE_COUNT': return Object.assign({}, state, {notifications: action.notifications, messages: action.messages, proposals: action.proposals, job_messages: action.job_messages});
